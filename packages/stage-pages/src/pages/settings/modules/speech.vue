...
import type { VoiceType } from '@proj-vera/stage-ui/composables'
...
import { OFFICIAL_SPEECH_PROVIDER_ID, OFFICIAL_SPEECH_STREAMING_PROVIDER_ID } from '@proj-vera/stage-ui/libs/providers/providers/official'
import { useVeraCardStore } from '@proj-vera/stage-ui/stores'
...
const veraCardStore = useVeraCardStore()
...
/**
 * Checks whether the selected provider is one of Vera's official TTS providers.
 */
...
watch([activeSpeechProvider, activeSpeechModel, activeSpeechVoiceId], ([provider, model, voiceId]) => {
  veraCardStore.updateActiveCardSpeech({ provider, model, voice_id: voiceId })
})
