---
title: xAI
description: 在 Vera 中配置 xAI Grok 聊天模型
---

xAI 服务商让 Vera 使用 Grok 聊天模型。其配置方式与常见 API Key 服务商相同。

::: info 为什么选择 xAI？
如果你已有 xAI API 账户，并希望在 Vera 中使用 Grok 模型，可以选择该服务商。
:::
...
::: warning API Key 安全
只在密码管理器或 Vera 的本地设置中保存 API Key。不要把密钥写入代码、提交到仓库或发送给他人。
:::
