...
import { createClient as createBetterWsClient } from '@proj-vera/better-ws'
import { createCrossWsConnector } from '@proj-vera/better-ws/client/crossws'
import { isTerminalAuthenticationServerErrorMessage, parseServerErrorMessage } from '@proj-vera/server-shared'
import { MessageHeartbeat, MessageHeartbeatKind } from '@proj-vera/server-shared/types'

import { parseEvent, stringifyEvent } from './codec'

export type { ClientConnector, ClientEvents } from '@proj-vera/better-ws'
...
/** Wraps a text websocket connector with Vera protocol serialization. */
