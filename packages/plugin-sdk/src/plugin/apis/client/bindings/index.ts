 ...
 */
export const pluginBindingApiListEventName = 'proj-vera:plugin-sdk:apis:client:bindings:list'
/**
 ...
 */
export const pluginBindingApiAnnounceEventName = 'proj-vera:plugin-sdk:apis:client:bindings:announce'
/**
 ...
 */
export const pluginBindingApiActivateEventName = 'proj-vera:plugin-sdk:apis:client:bindings:activate'
/**
 ...
 */
export const pluginBindingApiUpdateEventName = 'proj-vera:plugin-sdk:apis:client:bindings:update'
/**
 ...
 */
export const pluginBindingApiWithdrawEventName = 'proj-vera:plugin-sdk:apis:client:bindings:withdraw'
/**
 ...
 */
export const pluginBindingRegistryResourceKey = 'proj-vera:plugin-sdk:resources:bindings'
...
export function getKitBindingResourceKey(kitId: string) {
  return `proj-vera:plugin-sdk:resources:kits:${kitId}:bindings`
}
