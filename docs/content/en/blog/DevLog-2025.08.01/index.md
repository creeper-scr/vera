...
This is my first post on Project AIRI (upstream)'s DevLog, even though I have been working on it for a while.
...
In Project AIRI (upstream), [@nekomeowww](https://github.com/nekomeowww) also built an animated chat bubble component with motion effects:
...
Although the total line count of its core is less than 100, it may help you with your next project where you want to have some fancy text animations from a stream of UTF-8 bytes—like what we did in Project AIRI (upstream).

If you are interested in what we're doing in Project AIRI (upstream), please check out our GitHub repository at [moeru-ai/airi](https://github.com/moeru-ai/airi)!
