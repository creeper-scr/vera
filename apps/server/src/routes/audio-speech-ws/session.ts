...
import {
  ...
  VERA_ATTR_GEN_AI_GATEWAY_KEY_ID,
  VERA_ATTR_GEN_AI_GATEWAY_UPSTREAM_URL,
...
export function createSessionState(
  ...
  const span = tracer.startSpan('llm.gateway.tts.stream', {
    attributes: {
      [VERA_ATTR_GEN_AI_OPERATION_KIND]: 'text_to_speech_stream',
    },
  })
  ...
  async function dialUpstream() {
    ...
    span.setAttribute(VERA_ATTR_GEN_AI_GATEWAY_UPSTREAM_URL, upstreamURL)
    span.setAttribute(VERA_ATTR_GEN_AI_GATEWAY_KEY_ID, entry.id)
