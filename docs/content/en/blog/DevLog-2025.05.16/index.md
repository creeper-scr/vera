...
the [Project AIRI (upstream)](https://github.com/moeru-ai/airi)!

Sorry for being late for new update in
Project AIRI (upstream) through the posted DevLog, please forgive us
for the delay.
...
For the past few weeks, the major quests of Project AIRI (upstream) itself
...
## Project AIRI (upstream) major quests
