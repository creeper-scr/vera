import type { AnalyserWorkletParameters, BeatSyncSpectrumScale } from '@proj-vera/stage-shared/beat-sync'

import { DEFAULT_BEAT_SYNC_PARAMETERS } from '@proj-vera/stage-shared/beat-sync'
