import type { WebSocketBaseEvent, WebSocketEvents } from '@proj-vera/server-shared/types'

import type { ConsumerStickyAssignment } from './server-ws/vera/consumers'

import { describe, expect, it } from 'vitest'

import { heartbeatFrameFrom } from './server-ws/vera/codec'
import { selectConsumerPeerId } from './server-ws/vera/consumers'
import { resolveEventDelivery } from './server-ws/vera/routing'
