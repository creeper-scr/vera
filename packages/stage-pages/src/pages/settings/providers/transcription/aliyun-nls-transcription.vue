...
import type { HearingTranscriptionResult } from '@proj-vera/stage-ui/stores/modules/hearing'
import type { ServerEvent, ServerEvents } from '@proj-vera/stage-ui/stores/providers/aliyun'
import type { RemovableRef } from '@vueuse/core'
import type { TranscriptionProviderWithExtraOptions } from '@xsai-ext/providers/utils'

import vadWorkletUrl from '@proj-vera/stage-ui/workers/vad/process.worklet?worker&url'
...
import { useProviderValidation } from '@proj-vera/stage-ui/composables/use-provider-validation'
...
import { Button, FieldCombobox, FieldInput } from '@proj-vera/ui'
