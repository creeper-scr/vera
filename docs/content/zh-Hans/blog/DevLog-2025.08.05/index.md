...
贡献 Project AIRI (upstream) 的经验：[AIRIプロジェクトに参加した話 - YAMA-blog](https://yama-pro.blog/posts/airi/)
...
夜间构建流水线（原 `release-tamagotchi.yml`）已不在本 fork 维护；请从源码运行网页端或查看 [GitHub Releases](https://github.com/moeru-ai/airi/releases)。
...
- [`@proj-vera/chromatic`](https://github.com/proj-airi/chromatic)（由 [@sumimakito](https://github.com/sumimakito) 制作）
- [`@proj-vera/unocss-preset-chromatic`](https://github.com/proj-airi/chromatic)（由 [@sumimakito](https://github.com/sumimakito) 制作）
...
- [`@proj-vera/drizzle-orm-browser`](https://github.com/proj-airi/drizzle-orm-browser)（由我制作）
