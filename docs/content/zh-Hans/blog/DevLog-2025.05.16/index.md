...
大家好！我是 [Neko](https://github.com/nekomeowww)，[Project AIRI (upstream)](https://github.com/moeru-ai/airi) 的发起者！

很抱歉在 Project AIRI (upstream) 的 DevLog 更新上有所延迟，请原谅我们的拖延。
...
在过去的几周里，Project AIRI (upstream) 本身的主要任务有一段时间没有进展，也许我在 2025 年 3 月以来的大规模 UI 重构和发布后有些疲惫。大部分工作都是由社区维护者完成的，
