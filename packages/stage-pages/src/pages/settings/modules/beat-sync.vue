...
import type { BeatSyncDetectorState } from '@proj-vera/stage-shared/beat-sync'
...
} from '@proj-vera/stage-shared/beat-sync'
import { Alert, AudioSpectrumVisualizer } from '@proj-vera/stage-ui/components'
import { useSettingsBeatSync } from '@proj-vera/stage-ui/stores/settings'
import { Button, FieldCheckbox, FieldRange, SelectTab } from '@proj-vera/ui'
