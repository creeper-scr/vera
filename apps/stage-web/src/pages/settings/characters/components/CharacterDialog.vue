...
import type { Character, CreateCharacterPayload } from '@proj-vera/stage-ui/types/character'

import { useAnalytics } from '@proj-vera/stage-ui/composables/use-analytics'
import { useCharacterStore } from '@proj-vera/stage-ui/stores/characters'
import { CreateCharacterSchema } from '@proj-vera/stage-ui/types/character'
import { Button, FieldInput } from '@proj-vera/ui'
import {
  DialogContent,
  DialogOverlay,
  DialogPortal,
            ...
            <div class="flex-1 overflow-y-auto p-6">
              ...
              <div v-show="activeTab === 'identity'" class="space-y-4">
                <div class="grid grid-cols-2 gap-4">
                  <FieldInput v-model="form.characterId" label="Handle ID" placeholder="e.g. vera-core" required />
