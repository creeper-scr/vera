...
export function createMinecraftContext(): ContextMessage | null {
  ...
  return {
    ...
    text: [
      'Minecraft integration is active because Vera has observed a Minecraft service.',
      'Vera can oversee a connected Minecraft bot through Vera server events.',
      'Minecraft can send status and context upward, and Vera can send high-level guidance back down.',
      ...
      serviceStatus === 'online'
        ? 'The Minecraft service is online, but Vera should still rely on live bot context before assuming the bot can act.'
