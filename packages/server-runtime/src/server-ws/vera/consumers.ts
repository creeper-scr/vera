import type { DeliveryConfig } from '@proj-vera/server-shared/types'
...
/**
 * Candidate peer metadata used for Vera consumer selection.
 */
...
/**
 * Stored Vera consumer registration.
 */
...
/**
 * Sticky Vera consumer assignment stored by the consumer selector.
 */
...
/**
 * Checks whether a delivery mode targets the Vera consumer registry.
 */
...
/**
 * Normalizes delivery mode for Vera consumer registration.
 *
 * Before:
...
/**
 * Normalizes Vera consumer priority.
 *
 * Before:
 * - NaN
 *
...
/**
 * Selects a concrete peer for Vera consumer-style delivery modes.
 *
...
/**
 * Creates the Vera consumer delivery orchestrator for websocket peers.
 *
 * The orchestrator owns registration, unregister, listing, selection, and
 * sticky/round-robin cleanup state for Vera consumer routing.
 */
