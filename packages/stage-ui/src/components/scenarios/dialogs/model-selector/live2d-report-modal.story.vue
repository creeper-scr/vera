...
import type { Live2DValidationReport } from '@proj-vera/stage-ui-live2d'
...
const warningReport: Live2DValidationReport = {
  ...
  warnings: [
    ...
    'Missing preview image. Vera can still import this model, but the selector card will use a fallback preview.',
  ],
  checks: [
...
const invalidReport: Live2DValidationReport = {
  ...
  errors: [
    ...
    'BASENAME COLLISION: Filename "texture_00.png" exists in multiple locations: model/textures/texture_00.png, model/expressions/texture_00.png. This causes data loss in Vera\'s loader.',
  ],
  warnings: [
