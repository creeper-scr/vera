...
description: 使用本地 LM Studio 服务为 Vera 配置聊天模型
---
...
3. 如果 Vera 无法访问本地服务，请在 LM Studio 的服务器设置中启用 CORS。
...
无法连接时，先确认 Local Server 正在运行，且端口与 Base URL 一致。若 Vera 与 LM Studio 不在同一设备，使用可从 Vera 设备访问的局域网地址，并仅在可信网络中开放该服务。
