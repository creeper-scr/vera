...
export const VERA_CHAT_SESSION_ID_HEADER = 'x-vera-session-id'
export const VERA_CHAT_ROUND_ID_HEADER = 'x-vera-round-id'
export const VERA_CHAT_APP_SURFACE_HEADER = 'x-vera-app-surface'
