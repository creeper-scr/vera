...
export default defineConfig<ThemeConfig>({
                ...
                items: [
                  ...
                  { text: '服务商', collapsed: true, items: [
                    { text: '聊天服务商', collapsed: true, items: [
                      { text: 'Vera 官方提供商', link: withBase('/zh-Hans/docs/manual/config/providers/consciousness/official') },
                    ...
                    { text: '语音合成（TTS）', collapsed: true, items: [
                      { text: 'Vera 官方语音合成', link: withBase('/zh-Hans/docs/manual/config/providers/speech/official') },
                    ...
                    { text: '语音识别（ASR/STT）', collapsed: true, items: [
                      { text: 'Vera 官方语音识别', link: withBase('/zh-Hans/docs/manual/config/providers/transcription/official') },
  ...
  vite: {
    resolve: {
      alias: {
        '@proj-vera/stage-ui/components': resolve(join(import.meta.dirname, '..', '..', 'packages', 'stage-ui', 'src', 'components')),
