...
export interface ExtensionIdentity {
  /**
   * Stable extension identifier from `extension.vera.json`.
   */
  id: string
  /**
...
export enum WebSocketEventSource {
  Server = 'proj-vera:server-runtime',
  StageWeb = 'proj-vera:stage-web',
  StageTamagotchi = 'proj-vera:stage-tamagotchi',
}
...
interface GameCoopCapabilitiesRequestEvent {
  requestId: string
  sessionId: string
  adapterId: string
  /** Route selector used by the adapter service for its response. */
  replyTo: string
  destinations: Array<string>
}

interface GameCoopCapabilitiesEvent {
  requestId: string
  sessionId: string
  adapterId: string
...
interface GameCoopCommandEvent {
  adapterId: string
  command: GameCommand
  /** Route selector used for every lifecycle event from this action. */
  replyTo: string
  destinations: Array<string>
}

interface GameCoopCancelEvent {
  adapterId: string
  sessionId: string
  actionId: string
  reason?: string
...
interface GameCoopActionEvent {
  adapterId: string
  event: GameActionEvent
  destinations: Array<string>
}

interface GameCoopObservationSubscriptionEvent {
  adapterId: string
  sessionId: string
  /** Route selector receiving observations for this session. */
  replyTo: string
  destinations: Array<string>
}

interface GameCoopObservationEvent {
  adapterId: string
  observation: GameObservation
  destinations: Array<string>
}

interface GameCoopEnvironmentRequestEvent {
  requestId: string
  adapterId: string
  sessionId: string
  /** Route selector receiving the correlated environment snapshot. */
  replyTo: string
  destinations: Array<string>
}

interface GameCoopEnvironmentEvent {
  requestId: string
  adapterId: string
  sessionId: string
  environment?: GameEnvironmentSnapshot
  /** Session has no environment source; distinct from a sampling failure. */
  unavailable?: true
  error?: string
  destinations: Array<string>
}
...
export const gameCoopCapabilitiesRequest = defineProtocolEventa<GameCoopCapabilitiesRequestEvent>('game:coop:capabilities:request')
export const gameCoopCapabilities = defineProtocolEventa<GameCoopCapabilitiesEvent>('game:coop:capabilities')
export const gameCoopCommand = defineProtocolEventa<GameCoopCommandEvent>('game:coop:command')
export const gameCoopCancel = defineProtocolEventa<GameCoopCancelEvent>('game:coop:cancel')
export const gameCoopAction = defineProtocolEventa<GameCoopActionEvent>('game:coop:action')
export const gameCoopObservationSubscribe = defineProtocolEventa<GameCoopObservationSubscriptionEvent>('game:coop:observation:subscribe')
export const gameCoopObservationUnsubscribe = defineProtocolEventa<GameCoopObservationSubscriptionEvent>('game:coop:observation:unsubscribe')
export const gameCoopObservation = defineProtocolEventa<GameCoopObservationEvent>('game:coop:observation')
export const gameCoopEnvironmentRequest = defineProtocolEventa<GameCoopEnvironmentRequestEvent>('game:coop:environment:request')
export const gameCoopEnvironment = defineProtocolEventa<GameCoopEnvironmentEvent>('game:coop:environment')
...
export interface ProtocolEvents<C = undefined> {
  ...
  /** Requests one registered game adapter's current session capability catalog. */
  'game:coop:capabilities:request': GameCoopCapabilitiesRequestEvent
  /** Correlated capability response from one registered game adapter. */
  'game:coop:capabilities': GameCoopCapabilitiesEvent
  /** Sends one fully correlated command to its owning game adapter. */
  'game:coop:command': GameCoopCommandEvent
  /** Cancels one action without interrupting unrelated game work. */
  'game:coop:cancel': GameCoopCancelEvent
  /** Carries the correlated lifecycle emitted by a game adapter. */
  'game:coop:action': GameCoopActionEvent
  /** Starts world observations for one session and requester route. */
  'game:coop:observation:subscribe': GameCoopObservationSubscriptionEvent
  /** Stops world observations for one session and requester route. */
  'game:coop:observation:unsubscribe': GameCoopObservationSubscriptionEvent
  /** Carries one game-owned world observation to subscribed requester routes. */
  'game:coop:observation': GameCoopObservationEvent
  /** Requests one game adapter's current environment snapshot. */
  'game:coop:environment:request': GameCoopEnvironmentRequestEvent
  /** Correlated environment response from one game adapter. */
  'game:coop:environment': GameCoopEnvironmentEvent
