...
description: How to use Project Vera
---

## Settings

You can open settings in the system tray for further customization, for example,
changing the theme color of Vera, or switching to another model, either
...
You will have to restart Vera after loaded the model.
:::
