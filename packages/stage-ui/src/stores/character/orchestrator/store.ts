import type { SparkNotifyResponseControl } from '@proj-vera/core-agent/agents/spark-notify'
import type { WebSocketBaseEvent, WebSocketEventOf, WebSocketEvents } from '@proj-vera/server-sdk'

import { setupAgentSparkNotifyHandler } from '@proj-vera/core-agent/agents/spark-notify'
...
export { sparkNotifyCommandSchema } from '@proj-vera/core-agent/agents/spark-notify'
