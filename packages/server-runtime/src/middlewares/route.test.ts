import type { RouteTargetExpression, WebSocketBaseEvent, WebSocketEventOf, WebSocketEvents } from '@proj-vera/server-shared/types'
...
function createExtensionModulePeer(): AuthenticatedPeer {
  const peer = createPeer({
    id: 'peer-extension',
    name: 'vera-extension-chess',
    extension: 'vera-extension-chess',
