---
title: Contributing
description: Contributing to Project Vera
---
...
3. Install `git`, Node.js through `scoop`
...
### Local WS hub + game coop

```shell
pnpm dev:server
pnpm -F @proj-vera/minecraft-bot start
# or: pnpm -F @proj-vera/game-bridges start
```
...
Requires Postgres, Redis, and `apps/server/.env.local`.
