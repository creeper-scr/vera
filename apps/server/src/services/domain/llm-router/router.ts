...
import {
  VERA_ATTR_GEN_AI_GATEWAY_FALLBACK_DEPTH,
  VERA_ATTR_GEN_AI_GATEWAY_KEY_ID,
  VERA_ATTR_GEN_AI_GATEWAY_UPSTREAM_INDEX,
      ...
      try {
        ...
        if (response.ok) {
          ...
          trace.getActiveSpan()?.setAttributes({
            [VERA_ATTR_GEN_AI_GATEWAY_UPSTREAM_URL]: upstream.baseURL,
            [VERA_ATTR_GEN_AI_GATEWAY_UPSTREAM_INDEX]: upstreamIndex,
            [VERA_ATTR_GEN_AI_GATEWAY_KEY_ID]: key.id,
            [VERA_ATTR_GEN_AI_GATEWAY_FALLBACK_DEPTH]: attemptIndex,
          })
