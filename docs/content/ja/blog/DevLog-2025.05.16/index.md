...
こんにちは！[Project AIRI (upstream)](https://github.com/moeru-ai/airi) の発起人、[Neko](https://github.com/nekomeowww) です！

Project AIRI (upstream) の DevLog 更新が遅れてしまい申し訳ありません。私たちの遅延をお許しください。
...
過去数週間、Project AIRI (upstream) 本体の主要タスクはしばらく進展がありませんでした。おそらく、2025年3月からの大規模な UI リファクタリングとリリースの後で少し疲れていたのかもしれません。大部分の作業はコミュニティのメンテナによって行われました。
