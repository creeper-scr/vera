---
title: Mistral
description: 在 Vera 中配置 Mistral 作为大模型服务商
is_openai_compatible: true
---

Mistral 提供兼容 OpenAI 格式的聊天 API。完成本页配置后，Vera 可以在“意识”中使用 Mistral 提供的模型。

::: info 为什么选择 Mistral？
如果你已经使用 Mistral 模型，或希望在 Vera 中尝试其多语言模型，可以选择此服务商。
:::
