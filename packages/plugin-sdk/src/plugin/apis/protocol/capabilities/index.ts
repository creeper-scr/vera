 ...
 */
export const protocolCapabilityWaitEventName = 'proj-vera:plugin-sdk:apis:protocol:capabilities:wait'
/**
 ...
 */
export const protocolCapabilitySnapshotEventName = 'proj-vera:plugin-sdk:apis:protocol:capabilities:snapshot'
/**
