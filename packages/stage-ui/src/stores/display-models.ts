...
export const useDisplayModelsStore = defineStore('display-models', () => {
  ...
  async function initialize() {
    await import('@proj-vera/stage-ui-live2d/utils/live2d-zip-loader')
    await import('@proj-vera/stage-ui-live2d/utils/live2d-opfs-registration')

    const { loadLive2DModelPreview } = await import('@proj-vera/stage-ui-live2d/utils/live2d-preview')
    const { loadVrmModelPreview } = await import('@proj-vera/stage-ui-three/utils/vrm-preview')
    const { loadSpineModelPreview } = await import('@proj-vera/stage-ui-spine/utils/spine-preview')
    ...
    try {
      const { loadMMDModelPreview } = await import('@proj-vera/stage-ui-mmd/utils/mmd-preview')
