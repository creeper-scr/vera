...
import { createBackgroundRemovalAdapter } from '@proj-vera/stage-ui/libs/inference/adapters/background-removal'
import { Button, Checkbox, InputFile } from '@proj-vera/ui'
