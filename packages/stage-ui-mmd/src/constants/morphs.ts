...
/**
 * Logical morph slots Vera drives on an MMD model.
 *
...
/**
 * Maps Vera emotions to MMD morph targets.
 *
...
/**
 * Standard MMD humanoid bone names Vera manipulates for gaze and head aim.
 *
