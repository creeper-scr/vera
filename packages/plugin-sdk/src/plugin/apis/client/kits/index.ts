 ...
 */
export const pluginKitApiListEventName = 'proj-vera:plugin-sdk:apis:client:kits:list'
/**
 ...
 */
export const pluginKitApiGetCapabilitiesEventName = 'proj-vera:plugin-sdk:apis:client:kits:get-capabilities'
/**
 ...
 */
export const pluginKitRegistryResourceKey = 'proj-vera:plugin-sdk:resources:kits'
