...
const props = withDefaults(defineProps<{
  ...
  subtitle: '',
  links: () => ([
    { label: 'Home', href: '/docs/', icon: 'i-solar:home-smile-outline' },
    { label: 'Documentations', href: '/docs/en/docs/overview/', icon: 'i-solar:document-add-outline' },
    { label: 'GitHub (upstream)', href: 'https://github.com/moeru-ai/airi', icon: 'i-simple-icons:github' },
  ]),
})
