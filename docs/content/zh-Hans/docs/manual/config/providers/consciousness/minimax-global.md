...
description: 在 Vera 中配置海外版 MiniMax 作为大模型服务商
is_openai_compatible: true
---

本页适用于在 MiniMax 海外平台创建的 API Key。完成配置后，Vera 可以在“意识”中使用 MiniMax Global 提供的聊天模型。
...
3. 在 **设置 → 意识** 中选择 MiniMax Global 与该模型，并发送一条短消息确认 Vera 能够回复。
