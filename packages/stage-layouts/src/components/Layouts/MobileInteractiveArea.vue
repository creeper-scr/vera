...
import type { ChatHistoryItem } from '@proj-vera/stage-ui/types/chat'
import type { ChatProvider } from '@xsai-ext/providers/utils'

import { isStageTamagotchi } from '@proj-vera/stage-shared'
import { useThreeViewControl } from '@proj-vera/stage-ui-three'
import { ChatHistory, HearingConfigDialog } from '@proj-vera/stage-ui/components'
import { ChatSessionsDrawer } from '@proj-vera/stage-ui/components/scenarios/chat'
import { useAnalytics, useAudioAnalyzer } from '@proj-vera/stage-ui/composables'
...
import { useChatStreamStore } from '@proj-vera/stage-ui/stores/chat/stream-store'
import { useL2dViewControl } from '@proj-vera/stage-ui/stores/live2d'
...
import { BasicTextarea, useTheme } from '@proj-vera/ui'
