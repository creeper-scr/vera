---
title: NVIDIA NIM
description: 在 Vera 中配置 NVIDIA NIM 作为大模型服务商
is_openai_compatible: true
---

NVIDIA NIM 提供兼容 OpenAI 格式的聊天 API。完成本页配置后，Vera 可以在“意识”中使用 NVIDIA NIM 提供的模型。

::: info 为什么选择 NVIDIA NIM？
如果你已经在 NVIDIA NIM 平台使用模型服务，可以将同一套凭据接入 Vera。
:::
