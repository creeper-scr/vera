...
class VeraMToonMaterialLoaderPlugin extends MToonMaterialLoaderPlugin {
...
export function useVRMLoader() {
  ...
  loader.register((parser) => {
    ...
    // dual-material/groups structure later in Vera runtime hooks.
    const mtoonMaterialPlugin = new VeraMToonMaterialLoaderPlugin(parser)
