...
vi.mock('@proj-vera/stage-shared/composables', async () => {
...
describe('store settings-audio-devices', () => {
  ...
  it('restores the selected microphone without restoring listening consent', async () => {
   ...
   */
  // https://github.com/moeru-ai/vera/pull/2004#discussion_r3560276717
