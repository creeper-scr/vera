...
彼らは Pull Request がマージされた後、Project AIRI (upstream) に貢献した経験を共有するためにブログ記事を書きました：[AIRIプロジェクトに参加した話 - YAMA-blog](https://yama-pro.blog/posts/airi/)
...
旧 Nightly ワークフロー（`release-tamagotchi.yml`）はこの fork では維持していません。Web companion をソースから実行するか [GitHub Releases](https://github.com/moeru-ai/airi/releases) を参照してください。
...
- [`@proj-vera/chromatic`](https://github.com/proj-airi/chromatic)（[@sumimakito](https://github.com/sumimakito) 作）
- [`@proj-vera/unocss-preset-chromatic`](https://github.com/proj-airi/chromatic)（[@sumimakito](https://github.com/sumimakito) 作）
...
- [`@proj-vera/drizzle-orm-browser`](https://github.com/proj-airi/drizzle-orm-browser)（私作）
