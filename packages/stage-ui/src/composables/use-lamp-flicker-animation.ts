...
import { lampFlickerAnimationClass } from '@proj-vera/ui'
...
/**
 * Drives randomized keyframe timing for `.lamp-flicker-animation` from `@proj-vera/ui/main.css` while `flickerActive` is true.
 * Import `@proj-vera/ui/main.css` from the app global stylesheet (e.g. `styles/main.css`). When inactive, delay resets to 0s.
 */
