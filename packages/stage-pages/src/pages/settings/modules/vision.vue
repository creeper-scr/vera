...
import { Alert, ErrorContainer, RadioCardManySelect, RadioCardSimple } from '@proj-vera/stage-ui/components'
...
import { useVisionProcessingStore, useVisionStore } from '@proj-vera/stage-ui/stores/modules/vision'
import { useProvidersStore } from '@proj-vera/stage-ui/stores/providers'
import { FieldCheckbox, FieldRange } from '@proj-vera/ui'
...
watch([activeProvider, activeModel], ([provider, model]) => {
  veraCardStore.updateActiveCardVision({ provider, model })
})
