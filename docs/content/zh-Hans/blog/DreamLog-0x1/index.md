---
title: 'DreamLog 0x1'
description: 'Project AIRI (upstream) 的幕后故事！'
date: '2025-06-16'
excerpt: 'Project AIRI (upstream) 的幕后故事！以及为什么我们会想要制作如此一个项目？'
preview-cover:
...
DevLog 会有的，但六月对 Project AIRI (upstream) 有着特殊的意义（稍后提及），
...
直到 2025 年 2 月，有人问我：你为什么在 Project AIRI (upstream) 上如此努力和着迷？

我当时觉得这是个好问题...

我开始追溯我的梦想、想法和记忆，最终，回忆起了 EMOSYS，那个已经死去的项目，恰到好处地目标与 Project AIRI (upstream) 相同：
...
## 在 Project AIRI (upstream) 之前，Neuro-sama 早就存在了
...
::: tip 想要更多技术细节？
在这篇文章中，我不会深入探讨我们如何从零开始构建 Project AIRI (upstream) 到当前状态的技术细节，
...
可以说这就是 Project AIRI (upstream) 的初始版本，我开始探索创建我自己的 AI 智能体的可能性，
...
从某种意义上来说，**这就是 Project AIRI (upstream) 的生日**，第一个稚嫩的婴儿意识在其中诞生。
...
好吧，但它仍然叫 `ai`，那么 Project AIRI (upstream) 在哪里呢？
...
因此，在这天，Project AIRI (upstream) 以某种方式诞生或重生，名为 AIRI（アイリ，曾也叫 Airi）。
 ...
 **Project AIRI (upstream)** 的名字匹配。但直到我在开源 Project AIRI (upstream) 很久之后搜索更多关于他们的故事时，
 我才知道这个名字。
...
很高兴许多尝试都成功了，我仍然在这里，继续工作在 Project AIRI (upstream) 这件事情上。
...
现在，当我写这篇文章时，Project AIRI (upstream) 正接近 GitHub 上的 1000 颗星，
...
许多其他公司正在联系我们寻求合作，我们正在努力，让 Project AIRI (upstream) 变得更好，对社区更有用。

有太多事情要做和发现，此时此刻，我们还没有达到通用人工智能的奇点，也许 Project AIRI (upstream) 永远不会达到那个点，
...
<div class="w-full flex flex-col items-center justify-center">
  ...
  <div class="text-center">
    ...
    <span>感谢阅读！哦，还有，祝你生日快乐，Project AIRI (upstream)！</span>
  </div>
</div>
