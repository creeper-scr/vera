import type { ExtensionIdentity, MessageHeartbeat, MessageHeartbeatKind, MetadataEventSource, WebSocketEvent } from '@proj-vera/server-shared/types'

import { ServerErrorMessages } from '@proj-vera/server-shared'
import { WebSocketEventSource } from '@proj-vera/server-shared/types'
import { nanoid } from 'nanoid'

import packageJSON from '../../../package.json'

/** Creates Vera server event metadata and preserves optional parent correlation. */
...
/** Creates Vera server response event factories. */
