...
import { useBackgroundStore, useVeraCardStore } from '@proj-vera/stage-ui/stores'
import { Button, Callout } from '@proj-vera/ui'
...
const activeBackgroundId = computed({
  get: () => cardStore.activeCard?.extensions?.vera?.modules?.activeBackgroundId || 'none',
  set: (val: string) => {
