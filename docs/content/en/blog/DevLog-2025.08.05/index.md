...
experience contributing Project AIRI (upstream): [AIRIプロジェクトに参加した話 - YAMA-blog](https://yama-pro.blog/posts/airi/)
...
The former nightly workflow (`release-tamagotchi.yml`) is not maintained in this fork; run the web companion from source or see [GitHub Releases](https://github.com/moeru-ai/airi/releases).
...
- [`@proj-vera/chromatic`](https://github.com/proj-airi/chromatic) (by [@sumimakito](https://github.com/sumimakito))
- [`@proj-vera/unocss-preset-chromatic`](https://github.com/proj-airi/chromatic) (by [@sumimakito](https://github.com/sumimakito))
...
- [`@proj-vera/drizzle-orm-browser`](https://github.com/proj-airi/drizzle-orm-browser) (by me)
