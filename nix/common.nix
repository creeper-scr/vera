...
stdenvNoCC.mkDerivation (final: {
  ...
  assets = stdenvNoCC.mkDerivation {
    ...
    buildPhase = ''
      ...
      pnpm -F @proj-vera/stage-web run build
  ...
  meta = {
    ...
    longDescription = ''
      Vera is a soul container of AI waifu / virtual characters to bring them into our world,
    ...
    # While vera itself is licensed under MIT, it uses the nonfree Cubism SDK. Whether it's
