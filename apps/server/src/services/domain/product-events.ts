...
/**
 * Product event fact written to Vera's own Postgres analytics table.
 */
...
/** Explains whether Vera supplied a trustworthy USD cost for this generation. */
...
/**
 * Creates Vera's first-party product analytics event writer.
 *
 * Use when:
