...
const invalidMessage = 'Invalid Vera websocket message.'
...
/** Error thrown when websocket text cannot be parsed as an Vera event envelope. */
...
/** Serializes one Vera websocket protocol event with SuperJSON. */
