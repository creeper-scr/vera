...
export const DEFAULT_AUTH_UI_URL = 'https://accounts.vera.build/ui'
export const SERVER_DEV_API_SERVER_URL = 'https://vera-server-dev.up.railway.app'
export const SERVER_DEV_AUTH_UI_URL = 'https://server-dev.vera-server-auth.pages.dev/ui'
 ...
 *
 * Returns:
 * - The configured auth UI URL, except for the server-dev default pverang where
