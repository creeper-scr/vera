...
export const providerOfficialChat = defineProvider({
  ...
  description: 'Official AI provider by Vera.',
...
export const providerOfficialSpeech = defineProvider({
  ...
  description: 'Official text-to-speech provider by Vera.',
    ...
    listVoices: async (_config, _provider, model): Promise<VoiceInfo[]> => {
      ...
      return data.voices.map((v) => {
        ...
        return {
          ...
          // list when upstream compatibility ids differ from Vera's router ids.
...
export const providerOfficialSpeechStreaming = defineProvider({
  ...
  description: 'Official streaming text-to-speech provider by Vera (low-latency bidirectional WebSocket).',
...
export const providerOfficialTranscription = defineProvider({
  ...
  description: 'Official realtime speech-to-text provider by Vera.',
    ...
    listModels: async (): Promise<ModelInfo[]> => [
      {
        ...
        description: 'Realtime transcription routed by Vera',
      },
    ],
  },
})
