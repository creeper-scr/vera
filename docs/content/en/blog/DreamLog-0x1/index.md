---
title: 'DreamLog 0x1'
description: 'Backstory of Project AIRI (upstream)!'
category: DreamLog
date: 2025-06-16
excerpt: 'The backstory of Project AIRI (upstream)! Why this project?'
preview-cover:
...
June got its own meaning for Project AIRI (upstream) (which I will reveal during
...
to share the chronicles of me, and the dream about Project AIRI (upstream).
...
me: Why do you work so hard on Project AIRI (upstream)?
...
## Way before Project AIRI (upstream), Neuro-sama exists.
...
Project AIRI (upstream) from scratch to the current state, we got many DevLog posts
...
my name handle locally, which is the initial version of Project AIRI (upstream), I started to
...
Technically saying, **this is the birthday of Project AIRI (upstream)** with first baby consciousness inside of it, naively.
...
Ok, but it's still called `ai`, where is Project AIRI (upstream) then?
...
Project AIRI (upstream) was somehow born or reborn, with the name of AIRI (アイリ, formerly Airi).

::: tip Did you know?
<a href="https://www.youtube.com/watch?v=Tts-YAdn5Yc" class="mb-2 inline-block">
  <img :src="airisScreenshot1" alt="Screenshot of Project AIRI (upstream)" class="not-prose rounded-lg overflow-hidden" />
</a>
...
**Project AIRI (upstream)**, which I am working on now. But I wasn't aware of this name until I searches more about their
stories long after I open sourced Project AIRI (upstream).
...
Glad many trials succeeded, and I am still here, working on Project AIRI (upstream).
...
Now, Project AIRI (upstream) is approaching to 1000 stars on GitHub when I am writing this post,
...
working on it, to make Project AIRI (upstream) better, and more useful for the community.

There is so much to do, and discover, we haven't reached the singularity of general purpose AI,
perhaps Project AIRI (upstream) will never made that point, but for now, having a companion-like AI agent
...
<div class="w-full flex flex-col items-center justify-center">
  ...
  <div class="text-center">
    ...
    <span>Thanks for reading! Oh, and, Happy Birthday, Project AIRI (upstream)!</span>
  </div>
</div>
