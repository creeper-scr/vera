import type { ContextHistoryEntry, ContextIngestResult, ContextMessage } from '@proj-vera/core-agent'

import { createContextRegistry } from '@proj-vera/core-agent'
import { defineStore } from 'pinia'
import { readonly, ref, toRaw } from 'vue'

import { getEventSourceKey } from '../../utils/event-source'

export type { ContextHistoryEntry, ContextIngestResult } from '@proj-vera/core-agent'
