import type { ClientConnection, ClientConnector, ClientEvents } from '@proj-vera/better-ws'
import type { WebSocketBaseEvent, WebSocketEvent, WebSocketEventOptionalSource, WebSocketEvents } from '@proj-vera/server-shared/types'
