 ...
 * helper surface only lets Vera pass speed. Voice Pack pitch and volume must be
 * encoded before the request reaches unspeech because Vera sends pre-built SSML
