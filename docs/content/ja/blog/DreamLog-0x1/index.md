---
title: 'DreamLog 0x1'
description: 'Project AIRI (upstream) の舞台裏ストーリー！'
date: '2025-06-16'
excerpt: 'Project AIRI (upstream) の舞台裏ストーリー！なぜ私たちがこのようなプロジェクトを作りたかったのか？'
preview-cover:
...
DevLog はありますが、6月は Project AIRI (upstream) にとって特別な意味を持っています（後述します）。
GitHub で 1000 スターという次のマイルストーンに向かっている今、
これまでの旅を振り返る良い機会だと思いました。

そのため、私たちの年代記と、
Project AIRI (upstream) に関する夢を共有するために、ここに新しい記事カテゴリを作成することにしました。
...
2025年2月、ある人が私に尋ねるまでは。「なぜ Project AIRI (upstream) にこれほど熱心で夢中になっているのですか？」

私は当時、それは良い質問だと思いました...

私は自分の夢、アイデア、記憶を遡り始め、最終的に EMOSYS を思い出しました。あの死んだプロジェクトは、Project AIRI (upstream) と同じ目標を持っていました：
...
## Project AIRI (upstream) の前に、Neuro-sama はずっと前から存在していた
...
::: tip もっと技術的な詳細が知りたい？
この記事では、ゼロから Project AIRI (upstream) を現在の状態まで構築した技術的な詳細には深く立ち入りません。
...
これが Project AIRI (upstream) の初期バージョンだと言えます。私は自分の AI エージェントを作成する可能性を探り始め、
...
ある意味で、**これが Project AIRI (upstream) の誕生日です**。最初の未熟な赤ちゃんの意識がそこで生まれました。
...
さて、でもそれはまだ `ai` と呼ばれています。では Project AIRI (upstream) はどこにあるのでしょうか？
...
したがって、この日、Project AIRI (upstream) は何らかの形で誕生または再生し、AIRI（アイリ、かつては Airi とも呼ばれました）と名付けられました。

::: tip 知っていましたか？
<a href="https://www.youtube.com/watch?v=Tts-YAdn5Yc" class="mb-2 inline-block">
  <img :src="airisScreenshot1" alt="Screenshot of Project AIRI (upstream)" class="rounded-lg overflow-hidden" />
</a>
 ...
 **Project AIRI (upstream)** の名前と一致しています。しかし、Project AIRI (upstream) をオープンソース化してからずっと後に彼らの物語についてもっと検索するまで、
 私はこの名前を知りませんでした。
...
多くの試みが成功し、私がまだここにいて、Project AIRI (upstream) ということに取り組み続けていることを嬉しく思います。
...
現在、私がこの記事を書いている時点で、Project AIRI (upstream) は GitHub で 1000 スターに近づいており、
...
多くの他の企業が協力のために私たちに連絡してきています。私たちは Project AIRI (upstream) をより良くし、コミュニティにとってより有用なものにするために努力しています。

発見すべきことややるべきことはあまりにもたくさんあります。現時点では、私たちはまだ汎用人工知能の特異点には達していません。Project AIRI (upstream) は永遠にその点に達しないかもしれません。
...
<div class="w-full flex flex-col items-center justify-center">
  ...
  <div class="text-center">
    ...
    <span>読んでくれてありがとう！ああ、それから、誕生日おめでとう、Project AIRI (upstream)！</span>
  </div>
</div>
