...
basic/first version of Project AIRI (upstream) logo. The feeling of the logo looks like
this:
...
[documentation site](https://airi.build) of Project AIRI (upstream) online, for me,
