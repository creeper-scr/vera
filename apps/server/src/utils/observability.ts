// ---------------------------------------------------------------------------
// Span attribute constants (OTel semantic conventions + Vera custom)
// ---------------------------------------------------------------------------
...
// Vera custom span attributes
export const VERA_ATTR_BILLING_FLUX_CONSUMED = 'vera.billing.flux_consumed'
export const VERA_ATTR_GEN_AI_INPUT_MESSAGES = 'vera.gen_ai.input.messages'
export const VERA_ATTR_GEN_AI_INPUT_TEXT = 'vera.gen_ai.input.text'
export const VERA_ATTR_GEN_AI_OPERATION_KIND = 'vera.gen_ai.operation.kind'
export const VERA_ATTR_GEN_AI_OLLAMA_THINK = 'vera.gen_ai.ollama.think'
export const VERA_ATTR_GEN_AI_OUTPUT_FULL_TEXT = 'vera.gen_ai.output.full_text'
export const VERA_ATTR_GEN_AI_OUTPUT_TEXT = 'vera.gen_ai.output.text'
export const VERA_ATTR_GEN_AI_STREAM = 'vera.gen_ai.stream'
export const VERA_ATTR_GEN_AI_STREAM_INTERRUPTED = 'vera.gen_ai.stream_interrupted'

// Vera router gateway span attributes (in-process LLM/TTS routing — KTD-3).
// All prefixed `vera.gen_ai.gateway.*` to stay under the existing `vera.gen_ai.*`
// namespace already used by `vera.gen_ai.stream_interrupted`.
export const VERA_ATTR_GEN_AI_GATEWAY_UPSTREAM_URL = 'vera.gen_ai.gateway.upstream.url'
export const VERA_ATTR_GEN_AI_GATEWAY_UPSTREAM_INDEX = 'vera.gen_ai.gateway.upstream.index'
export const VERA_ATTR_GEN_AI_GATEWAY_KEY_ID = 'vera.gen_ai.gateway.key.id'
export const VERA_ATTR_GEN_AI_GATEWAY_FALLBACK_DEPTH = 'vera.gen_ai.gateway.fallback.depth'
export const VERA_ATTR_GEN_AI_GATEWAY_FALLBACK_REASON = 'vera.gen_ai.gateway.fallback.reason'
...
export const METRIC_FLUX_CONSUMED = 'vera.billing.flux.consumed'

// Vera billing — credit/debit visibility beyond raw consumption
export const METRIC_VERA_FLUX_CREDITED = 'vera.billing.flux.credited'
...
export const METRIC_VERA_FLUX_UNBILLED = 'vera.billing.flux.unbilled'
export const METRIC_VERA_TTS_CHARS = 'vera.billing.tts.chars'
export const METRIC_VERA_TTS_PREFLIGHT_REJECTIONS = 'vera.billing.tts.preflight_rejections'

// Vera observability — self-monitoring for the metric pipeline
export const METRIC_VERA_OBSERVABILITY_READ_ERRORS = 'vera.observability.read_errors'
...
export const METRIC_VERA_PRODUCT_EVENTS = 'vera.product.events'

// Vera revenue — actual money in (smallest currency unit, e.g. cents)
export const METRIC_VERA_STRIPE_REVENUE = 'vera.stripe.revenue'

// Vera email — transactional delivery health
export const METRIC_VERA_EMAIL_SEND = 'vera.email.send'
export const METRIC_VERA_EMAIL_FAILURES = 'vera.email.failures'
export const METRIC_VERA_EMAIL_DURATION = 'vera.email.duration'

// Vera rate limiting — abuse / attack visibility
export const METRIC_VERA_RATE_LIMIT_BLOCKED = 'vera.rate_limit.blocked'

// Vera GenAI — stream quality
export const METRIC_VERA_GEN_AI_STREAM_INTERRUPTED = 'vera.gen_ai.stream.interrupted'
export const METRIC_GEN_AI_CLIENT_FIRST_TOKEN_DURATION = 'gen_ai.client.first_token.duration'

// Vera router gateway — in-process LLM/TTS routing fallback / health signals.
//
...
export const METRIC_VERA_GEN_AI_GATEWAY_FALLBACK_COUNT = 'vera.gen_ai.gateway.fallback.count'
export const METRIC_VERA_GEN_AI_GATEWAY_UPSTREAM_ERRORS = 'vera.gen_ai.gateway.upstream.errors'
export const METRIC_VERA_GEN_AI_GATEWAY_KEY_EXHAUSTED_COUNT = 'vera.gen_ai.gateway.key.exhausted'
export const METRIC_VERA_GEN_AI_GATEWAY_SAME_STATUS_EXHAUSTION = 'vera.gen_ai.gateway.same_status_exhaustion'
export const METRIC_VERA_GEN_AI_GATEWAY_CONFIG_RELOAD = 'vera.gen_ai.gateway.config.reload'
export const METRIC_VERA_GEN_AI_GATEWAY_DECRYPT_FAILURES = 'vera.gen_ai.gateway.decrypt.failures'
export const METRIC_VERA_GEN_AI_GATEWAY_SUBSCRIBER_STATE = 'vera.gen_ai.gateway.subscriber_state'
export const METRIC_VERA_GEN_AI_GATEWAY_CONFIG_WRITE = 'vera.gen_ai.gateway.config.write'
export const METRIC_VERA_GEN_AI_GATEWAY_CONFIG_INVALID_HMAC = 'vera.gen_ai.gateway.config.invalid_hmac'
...
export const METRIC_VERA_GEN_AI_GATEWAY_POOL_SLOT_REJECTED = 'vera.gen_ai.gateway.pool.slot_rejected'
export const METRIC_VERA_GEN_AI_GATEWAY_POOL_SATURATION_MARKED = 'vera.gen_ai.gateway.pool.saturation_marked'
export const METRIC_VERA_GEN_AI_GATEWAY_POOL_INFLIGHT = 'vera.gen_ai.gateway.pool.inflight'
