...
const TRUSTED_EXACT_ORIGINS = [
  'https://vera.moeru.ai', // Production web app
  'capacitor://localhost', // Capacitor mobile (iOS)
  'ai.moeru.vera-pocket://links', // Android deep link
  'https://accounts.vera.build', // Standalone auth UI
  'https://server-dev.vera-server-auth.pages.dev', // Server-dev standalone auth UI
  'https://admin.vera.build', // Standalone admin UI
  'https://server-dev.vera-server-admin.pages.dev', // Server-dev standalone admin UI
]
