...
import { defaultSignInProviders } from '@proj-vera/stage-ui/components/auth'
import { resolveLinkedAccountOAuthErrorMessageKey, useAnalytics, useLinkedAccounts } from '@proj-vera/stage-ui/composables'
import { authClient } from '@proj-vera/stage-ui/libs/auth'
import { SERVER_URL } from '@proj-vera/stage-ui/libs/server'
import { useAuthStore } from '@proj-vera/stage-ui/stores/auth'
