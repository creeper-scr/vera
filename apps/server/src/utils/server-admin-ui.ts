...
export const DEFAULT_ADMIN_UI_URL = 'https://admin.vera.build'
export const SERVER_DEV_API_SERVER_URL = 'https://vera-server-dev.up.railway.app'
export const SERVER_DEV_ADMIN_UI_URL = 'https://server-dev.vera-server-admin.pages.dev'
 ...
 *   admin UI deployment from the `proj-vera` repository.
 ...
 *
 * Returns:
 * - The configured admin UI URL, except for the server-dev default pverang where
