...
export const OIDC_CLIENT_ID_WEB = 'vera-stage-web'
export const OIDC_CLIENT_ID_ELECTRON = 'vera-stage-electron'
export const OIDC_CLIENT_ID_POCKET = 'vera-stage-pocket'
...
export function createAuth(
    ...
    ...(env.AUTH_GOOGLE_CLIENT_ID && env.AUTH_GOOGLE_CLIENT_SECRET
      ? {
          google: {
            ...
            // Google emails are verified before OAuth issuance.
    ...
    ...(env.AUTH_GITHUB_CLIENT_ID && env.AUTH_GITHUB_CLIENT_SECRET
      ? {
          github: {
            ...
            prompt: 'select_account',
            // GitHub OAuth only authorizes verified identities.
  ...
  return betterAuth({
    ...
    session: {
      ...
      // current Vera flow the cost is negligible: cookie-based /get-session is
    ...
    account: {
      ...
      accountLinking: {
        ...
        // whose provider email differs from their Vera account email.
