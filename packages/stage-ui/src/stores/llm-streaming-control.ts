import type { LlmStreamingControlDispatchContext, LlmStreamingControlDispatchEvent } from '@proj-vera/pipelines-audio'

import { errorMessageFrom } from '@moeru/std'
import { createStreamingControlParser } from '@proj-vera/pipelines-audio'
...
export const useLlmStreamingControlStore = defineStore('llm-streaming-control', () => {
  ...
  const { post: postRemoteCall, data: incomingRemoteCall } = useBroadcastChannel<RemoteCallMessage, RemoteCallMessage>({ name: 'vera-streaming-control-turn-calls' })
